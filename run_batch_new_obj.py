"""Batch runner for all weighting scenarios with the updated objective (ped delay term added).
Covers all weights x LowPed/MedPed/HighPed x 3 seeds = 63 runs.
"""
import traci
