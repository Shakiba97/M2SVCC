"""
Batch runner: M2SVCC with Exclusive pedestrian phasing, Asymmetric volume.
Weights: (0.8,0.2) → (0.1,0.9)  [no (1.0,0.0)]
Ped levels: LowPed / MedPed / HighPed
Seeds: 10, 1000, 10000, 23423, 30000
Results moved to Results/Exclusive-Asymmetric/
"""
...
SEEDS = [42, 99, 500, 7777, 12345, 1000, 10000, 30000]
...
def run_scenario(weight, ped_label, poisson_gamma, seed):
    ...
    # Move result file to Exclusive-Asymmetric/
    generated = (
...
if __name__ == "__main__":
    ...
    print("\nAll Exclusive-Asymmetric runs complete.")
