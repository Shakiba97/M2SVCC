...
$gdxin %gdxincname%
$load i k h tau d_0 k_dynamics k_critical_points s_init s_critical v_init veh_dynamics veh_ice
$gdxin

variable
         f 'cost function',
         f_inst_ice(i,k) 'the instantanuous fuel consumption rate',
         f_inst_ev(i,k) 'the instantanuous energy consumption rate',
...
equations
         ...
         fuel_consumption_ice_2(i,k) 'calculate fuel consumption rate',
         fuel_consumption_ev(i,k) 'calculate ev energy consumption rate',
         fuel_consumption_ev_2(i,k) 'calculate ev energy consumption rate',
...
model m /cost, dynamics_speed, dynamics_position, car_following, fuel_consumption_ice, fuel_consumption_ev, fuel_consumption_ice_2, fuel_consumption_ev_2/;
