...
Fourth equ: the signal should not change for the next k steps because of pedestrian phase extension (not used for now so we set the threshold to 1)
$offtext
...
signal_rule_4(l)..                                                               sum(k$(ord(k)<1), p_c(l,k)) =e= 0;
...
model m /cost, cost_throughput, cost_distance, cost_transition, cost_delay, vehicle_dynamics_1, vehicle_dynamics_2, car_following, vehicle_position_1, vehicle_position_2, traffic_rule, signal_rule_1, signal_rule_2, signal_rule_3,signal_rule_4, phase_equal_1, phase_equal_2, phase_equal_3, phase_equal_4, phase_equal_5, phase_equal_6, phase_equal_7, phase_equal_8, phase_equal_9, phase_equal_10, phase_equal_11, phase_equal_12/;
